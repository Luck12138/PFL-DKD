...
def get_dataloader_CIFAR100(datadir, train_bs, test_bs, dataidxs=None, test_idxs=None, cache_train_data_set=None,
    ...
    train_ds = CIFAR100_truncated(datadir, dataidxs=dataidxs, train=True, transform=transform_train, download=True,
...
def load_partition_cifar100(data_dir, partition_method, partition_alpha, client_number, batch_size, logger):
