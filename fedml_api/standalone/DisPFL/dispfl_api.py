...
class dispflAPI(object):
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            for clnt_idx in range(self.args.client_num_in_total):
                ...
                new_mask, w_local_mdl, updates_matrix[clnt_idx], training_flops, num_comm_params, tst_results,avg_loss = client.train(copy.deepcopy(w_local_mdl), copy.deepcopy(mask_pers_local[clnt_idx]), round_idx)
    ...
    def _local_test_on_all_clients(self, tst_results_ths_round, round_idx):
            ...
            stats = {'test_acc_after': test_acc, 'test_loss_after': test_loss}
    ...
    def _local_test_on_all_clients_new_mask(self, tst_results_ths_round, round_idx):
        ...
        stats = {'test_acc_before': test_acc, 'test_loss_before': test_loss}
