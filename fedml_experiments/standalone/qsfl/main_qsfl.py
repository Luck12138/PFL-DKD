# -*- coding:utf-8 -*-
# @FileName  :main_qsfl.py
# @Time      :2022/9/14 16:57
# @Author    :lucas
import argparse
import logging
import os
...
from fedml_api.standalone.qsfl.my_model_trainer import MyModelTrainer
from fedml_api.standalone.qsfl.qsfl_api import QsflAPI
...
if __name__ == "__main__":
    parser = add_args(argparse.ArgumentParser(description='QSFL-standalone'))
    ...
    args.identity = "qsfl" + "-" + data_partition
    ...
    args.identity += "-upload" + str(args.client_num_per_round)
    ...
    qsflAPI=QsflAPI(dataset, device, args, model_trainer, logger)
    qsflAPI.train()